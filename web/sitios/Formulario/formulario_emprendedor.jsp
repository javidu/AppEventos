...
<%@page import="com.appeventos.DTO.Emprendedor"%>
    ...
    <body background="../../img/bgbody.jpg">
        ...
        <header id="zonahead">
            ...
            <div id="contenedor">
                    ...
                    <!--<form id="formularioemp" action="" method="get">-->
                    
                    <label>Nombre:  </label><input type="text" id="nombre"  name="nombre">
                    <label>Cedula:  </label><input type="text" id="cedula" name="cedula">
                    <label>Correo:  </label><input type="text" id="correo" name="correo"><br><br>
                    <div class="table-responsive">

                        <table class="table table-striped">
                            <thead id="titulo">

                            <td colspan="2"><strong>Para cada afirmación, indique la opción que mejor lo identifique. Para una mejor evaluaciÃ³n, deberÃ­a contestar
                            ...
                            <tbody>
                                ...
                                <tr >
                                    <td>3</td>
                                    <td>Estoy preparado/a, si fuera necesario, a bajar mis estÃ¡ndares de vida hasta que mi negocio sea rentable.</td>
                                ...
                                <tr >
                                    <td>6</td>
                                    <td>Percibo los problemas como desafÃ­os y oportunidades.</td>
                                ...
                                <tr >
                                    <td>7</td>
                                    <td>Me recupero rÃ¡pido de contratiempos personales.</td>
                                ...
                                <tr >
                                    <td>8</td>
                                    <td>Soy positivo/a y seguro/a de mÃ­ mismo/a.</td>
                                ...
                                <tr >
                                    <td>13</td>
                                    <td>Mi familia y esposa/o apoyan mi decisiÃ³n y estÃ¡n preparados a soportar el stress que tendrÃ© como consecuencia de mi empresa.</td>
                                ...
                                <tr >
                                    <td>14</td>
                                    <td>Tengo la resistencia fÃ­sica y la fortaleza emocional para manejar el estrÃ©s del trabajo, las horas extras, y el trabajo durante los fines de semana y feriados.</td>
                                ...
                                <tr >
                                    <td>15</td>
                                    <td>Soy organizado y me gusta planear con antelaciÃ³n.</td>
                                ...
                                <tr >
                                    <td>17</td>
                                    <td>Tengo buen juicio y serÃ© capaz de emplear a la gente indicada para mi negocio.</td>
                                ...
                                <tr >
                                    <td>19</td>
                                    <td>Si descubro que no tengo las habilidades bÃ¡sicas o el capital necesario para iniciar mi negocio, estoy dispuesto/a retrasar mis planes hasta que lo adquiera.</td>
                                ...
                                <tr >
                                    ...
                                    <td><input type="radio" name="rb22"></td>
                                    <td><input type="radio" name="rbb2"></td>
                                </tr>
                                ...
                                <tr >
                                    <td>28</td>
                                    <td>Busco ayuda, retroalimentaciÃ³n y crÃ­tica constructiva para mejorar como persona.</td>
                                ...
                                <tr >
                                    <td>30</td>
                                    <td>Tengo un buen o muy buen historial de crÃ©dito.</td>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr >
                                    <td colspan="5"><strong>3</strong> puntos por cada SI. <strong>2</strong> puntos por cada quizás. <strong>0</strong>  puntos por cada No</td>
                                </tr>
                                ...
                                <tr class="warning">
                                    <td><strong>71 y 58.</strong> Usted tiene potencial pero necesita mayor esfuerzo y dedicaciÃ³n para sacar adelante sus proyectos.</td>
                                </tr>
                        ...
                        <button id="boton" onclick="resultado()" class="btn btn-primary btn-lg">Calcular !</button>
                        <!--<button id="boton" type="button" class="btn btn-primary btn-lg">Calcular !</button>-->
                    </div>
