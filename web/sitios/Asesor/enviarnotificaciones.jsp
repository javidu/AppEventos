  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="active"><a href="#"><i class="fa fa-calendar"></i> <span>Enviar notificaciones</span></a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>Eventos <small>Enviar notificaciones</small></h1>
        <!--migajas de pan-->
        <ol class="breadcrumb">
          <li>
                ...
                <table id="tg" class="table table-striped table-bordered" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th><label>Enviar notificaciÃ³n <input type="checkbox" name=""></label></th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Correo</td>
                      <td>Puntaje</td>                   
                      <td><div class="col-sm-offset-4 col-sm-10"><input type="checkbox" name=""></div></td>                   
                      </tr>
